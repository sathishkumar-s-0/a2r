...
import { getCustomer, clearCustomer } from "@/pages/customer-login";
            ...
            {customer ? (
              <div className="hidden sm:flex items-center gap-2">
                <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary/10 border border-primary/20">
                  ...
                  <span className="text-sm font-medium text-foreground max-w-[100px] truncate">{customer.name}</span>
                </div>
                <Button variant="ghost" size="icon" onClick={handleLogout} title="Sign Out" className="text-foreground/60 hover:text-destructive">
